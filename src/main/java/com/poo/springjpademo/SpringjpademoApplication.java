...
public class SpringjpademoApplication {
	...
	public CommandLineRunner demo(cursoRepository cursoRepository, 
		...
		return (args) -> {
			...
			var pa1 = planoaulaRepository.findByCodigo("PA1");
			var pa2 = planoaulaRepository.findByCodigo("PA2");
			var pa3 = planoaulaRepository.findByCodigo("PA3");
			var pa4 = planoaulaRepository.findByCodigo("PA4");
			var pa5 = planoaulaRepository.findByCodigo("PA5");
			var pa6 = planoaulaRepository.findByCodigo("PA6");
			var pa7 = planoaulaRepository.findByCodigo("PA7");
			var pa8 = planoaulaRepository.findByCodigo("PA8");
